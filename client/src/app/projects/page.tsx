  ...
  return (
    <AppLayout title="Projects">
      <div className="flex justify-between items-center mb-6">
        <p className="text-orion-muted text-sm">{projects.length} projects total</p>
        {canEdit && (
        ...
        <Card>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {projects.map((p) => (
                  <tr key={p.id} className="border-b border-orion-border/50 hover:bg-orion-darker/30 transition-colors">
                    ...
                    <td className="py-3">
                      {canEdit && (
                        <div className="flex gap-2">
                          ...
                          <Button variant="ghost" size="sm" onClick={() => handleDelete(p.id)}><Trash2 className="w-3 h-3 text-orion-danger" /></Button>
                        </div>
                      )}
                    </td>
                  </tr>
                ...
                {projects.length === 0 && (
                  <tr><td colSpan={6} className="py-8 text-center text-orion-muted">No projects yet</td></tr>
                )}
              </tbody>
            </table>
          </div>
